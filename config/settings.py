...
#         'NAME': os.getenv('DB_NAME', 'emundo12'),
#         'USER': os.getenv('DB_USERNAME', 'pepe'),
#         'PASSWORD': os.getenv('DB_PASSWORD', '04j9ERdkQWimInUNbJ5xt7oh0DoqFH73'),
#         'HOST': os.getenv('DB_ADDR', 'localhost'),
